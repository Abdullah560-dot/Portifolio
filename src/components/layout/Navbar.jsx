            ...
            <div className="px-4 py-4 space-y-1">
              {navLinks.map(({ id, label }) => (
                <button
                  ...
                  onClick={() => scrollToSection(id)}
                  className={cn(
                    'block w-full text-left px-4 py-3 rounded-xl text-sm font-medium transition-colors cursor-pointer',
                    activeSection === id
              ...
              <div className="pt-2">
                <button
                  onClick={() => scrollToSection('contact')}
                  className="w-full px-4 py-3 text-sm font-semibold text-white rounded-xl bg-gradient-to-r from-primary to-primary-dark cursor-pointer"
                >
                  Let's Talk
                </button>
              </div>
